defmodule Mix.Tasks.Seed do
  ...
  defp seed_data() do
    ...
    Postgrex.query!(DB, "INSERT INTO pizzas(name, ingredients_id, price, image_url) VALUES($1, $2, $3, $4)", ["Ortolana", "[\"Tomatsås\", \"Mozzarella\", \"Paprika\", \"Aubergine\", \"Zucchini\", \"Gluten\"]", 120, "/uploads/pizzas/ortolana.svg"], pool: DBConnection.ConnectionPool)
