defmodule Mix.Tasks.Seed do
  ...
  defp seed_data() do
    ...
    Postgrex.query!(DB, "INSERT INTO pizzas(name, ingredients_id, price) VALUES($1, $2, $3)", ["Margherita", "[1, 2, 3]", 110], pool: DBConnection.ConnectionPool)
    Postgrex.query!(DB, "INSERT INTO pizzas(name, ingredients_id, price) VALUES($1, $2, $3)", ["Marinara", "[1]", 110], pool: DBConnection.ConnectionPool)
    Postgrex.query!(DB, "INSERT INTO pizzas(name, ingredients_id, price) VALUES($1, $2, $3)", ["Prosciutto e funghi", "[1, 2, 4, 5]", 120], pool: DBConnection.ConnectionPool)
    ...
    Postgrex.query!(DB, "INSERT INTO orders(user_id, user_name, current_order, state) VALUES($1, $2, $3, $4)", [1, "Carl Svensson", "[%{pizza_id: 1, add: [5], sub: [1], size: 1, amount: 2, price: 130}]", "Making"], pool: DBConnection.ConnectionPool)
    Postgrex.query!(DB, "INSERT INTO orders(user_id, user_name, current_order, state) VALUES($1, $2, $3, $4)", [-1, "Abdi Svensson", "[%{pizza_id: 1, add: [5], sub: [1], size: 1, amount: 2, price: 130}, %{pizza_id: 3, add: [3], sub: [4, 5], size: 2, amount: 1, price: 230}]", "Done"], pool: DBConnection.ConnectionPool)
  end
